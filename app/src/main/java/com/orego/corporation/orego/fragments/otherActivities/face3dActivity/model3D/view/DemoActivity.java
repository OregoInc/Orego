...
public class DemoActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.useless_activity_demo);
        ...
        CustomListViewAdapter adapter = new CustomListViewAdapter(this, R.layout.useless_activity_demo, rowItems);
...
class CustomListViewAdapter extends ArrayAdapter<RowItem> {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.useless_activity_demo_item, null);
